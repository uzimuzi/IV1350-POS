...
public class InventoryInformation {
    private ArrayList<ItemDTO> items;
        ...
        public InventoryInformation(){
            ...
            items.add(new ItemDTO(16, "Yogurt", 15.50, 500, 6, "Dairy", "liters"));
         ...
         * @throws DatabaseIssueException database exception
         * @throws ItemMissingException item missing exception
         * 
         */
        public ItemDTO findItemInformation(int itemID) throws DatabaseIssueException, ItemMissingException{

            if(itemID == 16){
                throw new DatabaseIssueException("There was a server issue!");
            }
            ...
            throw new ItemMissingException("Item: " + itemID + " was not found.");
        }
}
